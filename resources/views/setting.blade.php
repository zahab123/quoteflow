...
<body class="h-full bg-gray-100 flex flex-col" x-data="clientsData()">
    ...
    <div x-data="{ sidebarOpen: false }" class="h-full flex">
        ...
        <aside class="fixed inset-y-0 left-0 z-50 transform w-64 bg-white h-full shadow-2xl border-r border-gray-100 
            ...
            <main class="flex-1 p-6 overflow-auto space-y-6">
                <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
                    ...
                    <form action="{{ route('company.settings.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div>
                            ...
                            <input name="company_name" type="text" value="{{ $company->company_name ?? '' }}"
                        ...
                        <div>
                            ...
                            <img src="{{ asset('storage/' . $company->logo) }}"
                                class="w-20 h-20 mt-3 rounded-lg object-cover">
                            @endif
                        </div>
                ...
                <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
                    ...
                    <div class="flex items-center justify-between">
                        <span>Dark Mode</span>
                        <button @click="darkMode = !darkMode" class="px-4 py-2 rounded-lg font-semibold text-white"
