...
<body class="h-screen flex bg-gray-100">
    ...
    <aside class="w-60 bg-white h-full shadow-md border-r flex flex-col justify-between">
        ...
        <ul class="mt-4 space-y-1 text-gray-700 font-medium flex-1">
            ...
            <li><a href="/quotationlist" class="block px-6 py-2 hover:bg-gray-100 rounded bg-gray-200">Quotations</a></li>
    ...
    <div class="flex-1 flex flex-col h-full overflow-hidden">
        ...
        <main class="flex-1 p-10 overflow-auto">
            <div class="mb-6 flex justify-between items-center">
                ...
                <a href="/quotations" class="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition">
                    + New Quotation
                </a>
            </div>
            <div class="mb-6">
                ...
                <div class="bg-white rounded-xl shadow p-6 flex flex-col justify-between">
                    <div class="mb-4">
                        <div class="flex justify-between items-center mb-2">
                            <h2 class="font-bold text-lg text-gray-800">{{ $quotation->title }}</h2>
                        ...
                        <p class="text-gray-600"><span class="font-semibold">Client:</span> {{ $quotation->client->name }}</p>
                        <p class="text-gray-600"><span class="font-semibold">Date:</span> {{ $quotation->date->format('d M Y') }}</p>
                        <p class="text-gray-600"><span class="font-semibold">Items:</span> {{ $quotation->items_count }}</p>
                        <p class="text-gray-600"><span class="font-semibold">Total Amount:</span> ${{ number_format($quotation->total_amount, 2) }}</p>
                    </div>
