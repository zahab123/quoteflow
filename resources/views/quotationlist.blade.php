        ...
        <div class="flex-1 flex flex-col overflow-x-hidden overflow-y-auto">
            ...
            <main class="flex-1 p-4 md:p-10 overflow-auto bg-gray-50">
                <div class="mb-6 flex justify-between items-center">
                    ...
                    <a href="{{ route('quotations') }}" class="px-4 py-2 bg-gradient-to-r from-purple-600 to-pink-500 
                ...
                <form method="GET" action="{{ route('quotationlist') }}" class="mb-6 flex flex-col md:flex-row gap-4">
                    <input type="text" name="search" placeholder="Search quotations..." value="{{ request('search') }}"
                        class="w-full md:w-1/3 px-4 py-2 rounded-lg border border-gray-300 shadow-sm 
                          focus:outline-none focus:ring-2 focus:ring-purple-500" />

                    <select name="status" class="w-full md:w-48 px-4 py-2 rounded-lg border border-gray-300 shadow-sm 
                           focus:outline-none focus:ring-2 focus:ring-purple-500">
                    ...
                    <div x-data="{ copied: false }"
                        ...
                        <div class="mb-4">
                            <div class="flex justify-between items-start mb-1">
                                ...
                                <span
                                    class="text-xs font-medium px-3 py-1 rounded-full whitespace-nowrap {{ $statusClass }}">
                                    {{ $quotation->status }}
                                </span>
                            </div>
                        ...
                        <div class="space-y-2 mb-6">
                            <div class="flex justify-between text-sm">
                                ...
                                <span
                                    class="text-gray-700 font-medium">{{ $quotation->created_at->format('Y-m-d') }}</span>
                            </div>

                            <div class="flex justify-between text-sm">
                                <span class="text-gray-500">Items:</span>
                                <span class="text-gray-700 font-medium">{{ optional($quotation->items)->count() ?? 0 }}
                                    items</span>
                            </div>
                        ...
                        <div class="flex items-center gap-3">
                            <a href="{{ route('view', $quotation->id) }}"
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                                    ...
                                    <path
                                        d="M2.062 12C3.085 7.944 7.058 5 12 5s8.916 2.944 9.938 7c-1.022 4.056-4.996 7-9.938 7S3.085 16.056 2.062 12z" />
