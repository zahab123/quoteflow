        ...
        <div class="w-full max-w-md bg-white shadow-xl rounded-2xl p-8 lg:p-12">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="flex items-center justify-between mt-6">
                    ...
                    <a class="text-sm text-purple-600 hover:text-purple-800 transition duration-200"
                ...
                <p class="text-center text-gray-500 mt-6">
                    ...
                    <a href="{{ route('register') }}"
                        class="text-purple-600 font-semibold hover:text-purple-800 transition duration-200">Create one
                        now</a>
                </p>
            </form>
