        ...
        <div class="w-full max-w-md bg-white shadow-xl rounded-2xl p-8 lg:p-12">
            ...
            <form method="POST" action="{{ route('password.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <x-text-input id="login_by" class="block mt-1 w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition duration-200" type="text" name="login_by" :value="old('login_by', $request->login_by)" required autofocus autocomplete="username" />
