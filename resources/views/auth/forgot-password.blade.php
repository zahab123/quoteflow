...
<body class="min-h-screen flex flex-col lg:flex-row bg-gray-100">
    <div class="hidden lg:flex w-full lg:w-1/2 bg-gradient-to-br from-purple-600 to-blue-500 text-white flex-col justify-center p-16">
        ...
        <p class="text-lg opacity-90 mb-12">
            Enter your username or email and we will send you a link to reset your password. Stay secure and in control of your account.
        </p>
    </div>
        ...
        <div class="w-full max-w-md bg-white shadow-xl rounded-2xl p-8 lg:p-12">
            ...
            <form method="POST" action="{{ route('password.email') }}">
                ...
                <div class="mb-4">
                    ...
                    <x-text-input id="login_by" class="block mt-1 w-full border border-gray-300 rounded-lg px-4 py-2 focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition duration-200" type="text" name="login_by" :value="old('login_by')" required autofocus />
