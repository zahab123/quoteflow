...
<body class="h-full bg-gray-100 flex flex-col">
            ...
            <main class="flex-1 p-10 overflow-auto">
                ...
                <form action="{{ route('addquotation') }}" method="POST">
                    ...
                    <div class="bg-white p-6 rounded-xl shadow mb-6">
                        ...
                        <div id="items-container">
                            ...
                            <div class="mb-4 item-row">
                                <div
                                    class="flex flex-col relative mb-4 p-4 border border-gray-300 rounded-lg shadow-md transition duration-300 hover:shadow-lg">
                                    <label class="text-sm font-semibold text-gray-700 mb-1">Description</label>
                                    <div class="relative">
                                        <input name="items[0][description]" placeholder="Enter item description..."
                                            ...
                                            required id="item-0-description">
                                        <button type="button" onclick="generateDescription(this, 'item-0-description')"
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-3">
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <input name="items[0][unit_price]" type="number" step="0.01" value="0"
                                    ...
                                    <div class="flex flex-col">
                                        ...
                                        <input name="items[0][discount]" type="number" step="0.01" value="0"
                    ...
                    <div class="bg-white p-6 rounded-xl shadow mb-6">
                        ...
                        <textarea id="notes_field" name="notes" class="w-full border rounded-lg p-3 mt-2"
    ...
    async function generateDescription(button) {
        ...
        try {
            ...
            descriptionInput.placeholder = 'AI content is generating...';
