                ...
                <div class="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16 items-center">
                        <div class="flex items-center space-x-4">
                            ...
                            <h1 class="text-xl font-semibold text-gray-800 **hidden sm:block**">Create Quotation</h1>
        ...
        <main class="flex-1 p-10 overflow-auto">
            ...
            <form action="{{ route('addquotation') }}" method="POST">
                ...
                <div class="flex gap-3">
                    ...
                    <button type="submit" name="status" value="draft" class="px-5 py-2 rounded-lg bg-gray-500 text-white hover:bg-gray-600 transition">
                        Save as Draft
                    </button>
                </div>
            </form>
